...
// If request contains ?ajax=1&action=..., we'll return HTML rows.
// This allows us to keep frontend and backend in one file.
// To split later: extract each case below into its own file (see comments later).
// -----------------------------
if (isset($_GET['ajax']) && $_GET['ajax'] == '1') {
    ...
    if ($action === 'borrowed') {
        ...
        $sql = "SELECT br.Borrow_ID, br.User_Type, br.User_ID, br.Borrow_Date, br.Return_Date, br.Status,
