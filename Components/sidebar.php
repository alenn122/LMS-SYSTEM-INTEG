...
$librarian_name = "Jonathan Allen";
$librarian_email = "";
$librarian_pic = "../img/loa_logo.png"; // fallback image

if (isset($_SESSION['librarian_id'])) {
    $id = $_SESSION['librarian_id'];
    $query = mysqli_query($conn, "SELECT Name, Email, picture FROM librarian WHERE Librarian_ID='$id' LIMIT 1");
